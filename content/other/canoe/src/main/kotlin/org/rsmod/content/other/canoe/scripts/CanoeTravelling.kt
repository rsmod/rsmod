...
import org.rsmod.content.other.canoe.configs.canoe_components
import org.rsmod.content.other.canoe.configs.canoe_interfaces
import org.rsmod.content.other.canoe.configs.canoe_locs
import org.rsmod.content.other.canoe.configs.canoe_npcs
...
constructor(
    ...
    private suspend fun ProtectedAccess.startCutscene(
        ...
        if (type == CutsceneType.Grass) {
            ...
            rebuildAppearance()
            delay(1)
            anim(canoe_seqs.human_canoe_paddle)
