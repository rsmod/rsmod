...
@JvmInline
public value class I14Coordinates(public val packed: Int) {
    ...
    public fun translate(xOffset: Int, zOffset: Int, levelOffset: Int = 0): I14Coordinates = I14Coordinates(
        x = x + xOffset,
        z = z + zOffset,
        level = level + levelOffset
    )

    public fun translateX(offset: Int): I14Coordinates = translate(offset, 0, 0)

    public fun translateZ(offset: Int): I14Coordinates = translate(0, offset, 0)

    public fun translateLevel(offset: Int): I14Coordinates = translate(0, 0, offset)

    public operator fun minus(other: I14Coordinates): I14Coordinates {
        return translate(-other.x, -other.z, -other.level)
    }

    public operator fun plus(other: I14Coordinates): I14Coordinates {
        return translate(other.x, other.z, other.level)
    }
    ...
    public override fun toString(): String {
        return "I14Coordinates(x=$x, z=$z, level=$level)"
    }

    @Suppress("MemberVisibilityCanBePrivate")
    public companion object {

        public val ZERO: I14Coordinates = I14Coordinates(0)
        ...
        /**
         * Converts the absolute coordinates ([x], [z], [level]) to [I14Coordinates].
         * In other words, this function will trim down the given coordinates in order
         * to fit the respective amount of bits in [I14Coordinates].
         */
        public fun convert(x: Int, z: Int, level: Int): I14Coordinates {
            return I14Coordinates(x and X_BIT_MASK, z and Z_BIT_MASK, level and LEVEL_BIT_MASK)
        }
