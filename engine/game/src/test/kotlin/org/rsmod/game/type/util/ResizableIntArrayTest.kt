...
import org.rsmod.game.type.util.ResizableIntArray.Companion.DEFAULT_CAPACITY

class ResizableIntArrayTest {
    @Test
    fun `construct with default capacity`() {
        val array = ResizableIntArray()
        assertEquals(DEFAULT_CAPACITY, array.capacity)
    }

    @Test
    fun `construct with set capacity`() {
        val array = ResizableIntArray(capacity = 50)
        assertEquals(50, array.capacity)
    }

    @Test
    fun `construct with varargs`() {
        val array = ResizableIntArray(1, 2, 3, 4, 5)
    ...
    fun `compact on toIntArray`() {
        val array = ResizableIntArray(arrayOf(1, 2, 3, 4, 5, null, null))
    ...
    fun `throw error on gaps`() {
        val array = ResizableIntArray(arrayOf(1, 2, 3, 4, 5, null, null, 8, 9, 10))
