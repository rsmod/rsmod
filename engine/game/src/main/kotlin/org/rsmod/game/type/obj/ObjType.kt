...
public class UnpackedObjType(
    ...
    public fun computeIdentityHash(): Long {
        ...
        result = 61 * result + stockmarket.hashCode()
        result = 61 * result + weight
        result = 61 * result + category
        result = 61 * result + certlink
        result = 61 * result + certtemplate
        ...
        result = 61 * result + generateCertificate.hashCode()
        result = 61 * result + generatePlaceholder.hashCode()
        result = 61 * result + objvar.contentHashCode()
        result = 61 * result + playerCost
        result = 61 * result + playerCostDerived
        result = 61 * result + playerCostDerivedConst
        result = 61 * result + stockMarketBuyLimit
        result = 61 * result + stockMarketRecalcUsers
