...
object BaseNpcs : NpcReferences() {
    val man_id_3106 = find("man_id_3106", 5122201184108336581)
    val man_id_3107 = find("man_id_3107", 5122201184108336582)
    val man_id_3108 = find("man_id_3108", 5122201184108336583)
    val woman_id_3111 = find("woman_id_3111", 7243513195153570706)
