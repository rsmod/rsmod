...
object BaseVarBits : VarBitReferences() {
    ...
    val enabled_prayers = find("prayer_allactive", 4277063138774)
    val quickprayer_active = find("quickprayer_active", 19321012450480)

    val thick_skin = find("prayer_thickskin", 4277063137069)
    val burst_of_strength = find("prayer_burstofstrength", 4277063140852)
    val clarity_of_thought = find("prayer_clarityofthought", 4277063144635)
    val rock_skin = find("prayer_rockskin", 4277063148418)
    val superhuman_strength = find("prayer_superhumanstrength", 4277063152201)
    val improved_reflexes = find("prayer_improvedreflexes", 4277063155984)
    val rapid_restore = find("prayer_rapidrestore", 4277063159767)
    val rapid_heal = find("prayer_rapidheal", 4277063163550)
    val protect_item = find("prayer_protectitem", 4277063167333)
    val steel_skin = find("prayer_steelskin", 4277063171116)
    val ultimate_strength = find("prayer_ultimatestrength", 4277063174899)
    val incredible_reflexes = find("prayer_incrediblereflexes", 4277063178682)
    val protect_from_magic = find("prayer_protectfrommagic", 4277063182465)
    val protect_from_missiles = find("prayer_protectfrommissiles", 4277063186248)
    val protect_from_melee = find("prayer_protectfrommelee", 4277063190031)
    ...
    val sharp_eye = find("prayer_sharpeye", 4277063205163)
    val mystic_will = find("prayer_mysticwill", 4277063208946)
    val hawk_eye = find("prayer_hawkeye", 4277063212729)
    val mystic_lore = find("prayer_mysticlore", 4277063216512)
    val eagle_eye = find("prayer_eagleeye", 4277063220295)
    val mystic_might = find("prayer_mysticmight", 4277063224078)
