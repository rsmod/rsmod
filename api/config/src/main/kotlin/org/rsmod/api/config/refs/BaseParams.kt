...
object BaseParams : ParamReferences() {
    ...
    val forcehitchance_melee: ParamInt = find("forcehitchance_melee")
    val forcehitchance_magic: ParamInt = find("forcehitchance_magic")
    val forcehitchance_range: ParamInt = find("forcehitchance_range")
